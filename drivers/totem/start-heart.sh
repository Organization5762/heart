...
RP1_SCANNER_CANDIDATE="${HEART_RP1_HUB75_SCANNER_CANDIDATE:-state32-dmapipeline4x4-rr01-cols256-frame8-dwell8-electrodragonp0-addr2slow-clk2slow-latoe2slow-lat2-addrnop8-rgbsetclr-preclk1-unroll8}"
...
HEART_RGB_MATRIX_HARDWARE_MAPPING="${HEART_RGB_MATRIX_HARDWARE_MAPPING:-electrodragon_p0}" \
...
(
  cd "${RP1_PIO_DIR}"
  RP1_HUB75_PWM_BITS="${RP1_SCANNER_PWM_BITS}" "${SCANNER_RUNNER}" \
