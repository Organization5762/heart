...
COLUMNS: tuple[ColumnDef, ...] = (
    ...
    ColumnDef(
        ...
        (
            ...
            NodeDef("mode_router", "GameModes / Mode Router", "orchestrator"),
            NodeDef(
                "native_scene_bridge",
            ...
            NodeDef(
                "composition_manager",
                "ComposedRenderer Batch Composition",
                "service",
            ),
        ),
    ),
    ColumnDef(
        ...
        (
            ...
            NodeDef("frame_tick", "FrameTickController", "input"),
            NodeDef("keyboard_controller", "KeyboardController", "input"),
            NodeDef("gamepad_controller", "GamepadController", "input"),
            NodeDef(
                "input_profiles",
                "Navigation / Mandelbrot /\nAccelerometer Debug Profiles",
                "input",
            ),
...
EDGES: tuple[EdgeDef, ...] = (
    ...
    EdgeDef("registry", "container_builder"),
    EdgeDef("container_builder", "runtime_container"),
    EdgeDef("runtime_container", "loop"),
    EdgeDef("loop", "configurer"),
    EdgeDef("configurer", "mode_router", "adds modes & scenes"),
    EdgeDef("loop", "mode_router"),
    EdgeDef("loop", "composition_manager"),
    EdgeDef("runtime_container", "mode_router"),
    EdgeDef("runtime_container", "peripheral_manager"),
    EdgeDef("mode_router", "native_scene_bridge"),
    EdgeDef("native_scene_bridge", "mode_services"),
    EdgeDef("mode_services", "composition_manager"),
    ...
    EdgeDef("loop", "frame_tick"),
    EdgeDef("loop", "frame_handoff"),
    EdgeDef("frame_tick", "mode_services"),
    EdgeDef("frame_tick", "input_debug_tap"),
    EdgeDef("peripheral_manager", "interval_scheduler"),
    EdgeDef("peripheral_manager", "input_scheduler"),
    EdgeDef("peripheral_manager", "blocking_scheduler"),
    EdgeDef("peripheral_manager", "frame_handoff"),
    EdgeDef("blocking_scheduler", "switch"),
    EdgeDef("input_scheduler", "gamepad"),
    EdgeDef("blocking_scheduler", "sensors"),
    EdgeDef("peripheral_manager", "heart_rate"),
    EdgeDef("peripheral_manager", "phone_text"),
    EdgeDef("switch", "input_profiles"),
    EdgeDef("frame_handoff", "keyboard_controller"),
    EdgeDef("frame_handoff", "gamepad_controller"),
    EdgeDef("gamepad", "gamepad_controller"),
    EdgeDef("sensors", "input_profiles"),
    EdgeDef("heart_rate", "mode_services"),
    EdgeDef("phone_text", "mode_services"),
    EdgeDef("keyboard_controller", "input_profiles"),
    EdgeDef("keyboard_controller", "mode_services"),
    EdgeDef("keyboard_controller", "input_debug_tap"),
    EdgeDef("gamepad_controller", "input_profiles"),
    EdgeDef("gamepad_controller", "input_debug_tap"),
    EdgeDef("input_profiles", "mode_router"),
    EdgeDef("input_profiles", "mode_services"),
    EdgeDef("input_profiles", "input_debug_tap"),
)
