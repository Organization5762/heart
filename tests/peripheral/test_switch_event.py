...
class TestPeripheralSwitchEvent:
    ...
    def test_fake_switch_emits_bus_events(self) -> None:
        ...
        # entry = state_store.get_latest(BUTTON_PRESS, producer_id=7)
        entry = None
    ...
    def test_bluetooth_switch_routes_producer_events(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        # rotation_entry = state_store.get_latest(SWITCH_ROTATION, producer_id=0)
        rotation_entry = None
    ...
    def test_bluetooth_switch_emits_button_press_for_each_producer(
        ...
        # entry_main = state_store.get_latest(BUTTON_PRESS, producer_id=0)
        # entry_secondary = state_store.get_latest(BUTTON_PRESS, producer_id=1)
    ...
    def test_bluetooth_switch_emits_rotation_for_each_producer(
        ...
        # entry_main = state_store.get_latest(SWITCH_ROTATION, producer_id=0)
        # entry_secondary = state_store.get_latest(SWITCH_ROTATION, producer_id=2)
    ...
    def test_bluetooth_switch_emits_long_press_for_each_producer(
        ...
        # entry_main = state_store.get_latest(BUTTON_LONG_PRESS, producer_id=0)
        # entry_secondary = state_store.get_latest(BUTTON_LONG_PRESS, producer_id=3)
