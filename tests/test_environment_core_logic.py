"""Additional tests for core logic in :mod:`heart.runtime.game_loop`."""
...
class TestEnvironmentCoreLogic:
    """Group runtime loop core logic tests so render-loop behaviour stays reliable. This preserves confidence in runtime orchestration for end-to-end scenarios."""
