"""Tests for the Python-facing heart_rgb_matrix_driver matrix compatibility API."""
...
HEART_RGB_MATRIX_DRIVER_PYTHON_PATH = (
    Path(__file__).resolve().parents[2] / "rust" / "heart_rgb_matrix_driver" / "python"
)
