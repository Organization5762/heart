...
from heart.display.renderers.max_bpm_screen.provider import (
    AVATAR_MAPPINGS, AvatarBpmStateProvider)
from heart.display.renderers.max_bpm_screen.state import AvatarBpmRendererState
