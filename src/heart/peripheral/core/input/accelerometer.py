...
class AccelerometerPublisher:
    source_streams: tuple[Subscribable[Acceleration | None], ...]
...
class AccelerometerController:
    def __init__(
        ...
        *,
        graph: Graph,
        source_stream: Subscribable[Acceleration],
    ) -> None:
        self._graph = graph
    ...
    def observable(self) -> Subscribable[Acceleration]:
        return self.node()
...
class AccelerometerDebugProfile:
    ...
    @cached_property
    def _keyboard_observable(self) -> Subscribable[Acceleration | None]:
    ...
    def observable(self) -> Subscribable[Acceleration | None]:
        return self.node()
