...
- `three_fractal` now lives in `src/heart/display/renderers/three_fractal/` with a provider that creates the OpenGL runtime state and a renderer wrapper that delegates frames to that runtime.
