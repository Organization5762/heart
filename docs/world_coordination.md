...
Heart main `0fe72ba0f8e5e30563c2b028a8ceef596509dc2c` contains the signer-backed
mesh and pins public ManyFold reconnect fix
`89c1c8b01cfee1785cbdc7c72cc3876b61b7b8a7`. ManyFold `0.1.42` predates that
fix; replace the Git pin with a qualified later release when one is published.
